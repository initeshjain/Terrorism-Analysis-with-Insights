...
def main():
  load_data()
  open_browser()
  global app, df, month_value, date_value, region_value, country_value, state_value, city_value, attack_value, year_value, tab, search, chart_dp_value, subtabs2, chart_year_selector
